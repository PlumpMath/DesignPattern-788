...
public class CalculateClient {
	...
	public static void main(String[] args) {
		...
		System.out.println("撤销一次运算后的结果为：" + operation.getResult());
		calculator.undoPressed();
		System.out.println("再撤销一次运算后的结果为：" + operation.getResult());

		// 测试恢复
		System.out.println("=========测试恢复=========");
		calculator.redoPressed();
		System.out.println("恢复一次运算后的结果为：" + operation.getResult());
		calculator.redoPressed();
		System.out.println("再恢复一次运算后的结果为：" + operation.getResult());
