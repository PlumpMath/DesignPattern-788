	...
	public void showUserDeps(User user) {
		for (DepUserModel du : this.depUserCol) {
			if (du.getUserId().equals(user.getUserId())) {
				System.out.println("人员编号=" + user.getUserId() + "下面拥有人员，其编号是："
						+ du.getDepId());
			}
		}
	}
